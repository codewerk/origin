...
namespace Fixit
{
    public partial class PunctuationCharacter : Form
    {
        public PunctuationCharacter()
        {
            InitializeComponent();
        }
        ...
        private void btnFixIT_Click(object sender, EventArgs e)
        {
            ...
            fixLog.CreateLog("Solution 726 Err 217900 TPP Incorrect Syntax", ref dataGridView1, _SharedDataPath);
        ...
        private void btnCopyGrid_Click(object sender, EventArgs e)//copy the grid for pasting 
        {           
        ...
        private void btnSearchForFeeSlip_Click(object sender, EventArgs e)
        {
            ...
            string formname = "PunctuationCharacter";
            string searchValue = "";
            int searchColumn = 1;
            ...
            PunctuationCharacter pc = (PunctuationCharacter)Application.OpenForms[formname];
            DataGridView dgv = pc.dataGridView1;

            int i = 0;
            pc.lblFeeslipsFound.Text = "";
            ...
            try
            {
                ...
                foreach (DataGridViewRow row in dgv.Rows)
                {
                    ...
                    if (row.Cells[searchColumn].Value.ToString().Equals(searchValue))
                    {
                        ...
                        if (pc != null)
                        {
                            pc.lblFeeslipsFound.Text = "Found: " + ++i;
                        }
                    }
